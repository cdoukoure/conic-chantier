  ...
  <div class="modal fade" id="movementModal" tabindex="-1">
    ...
    <form id="movementForm">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3"><label>Date opération</label><input type="date" name="operation_date" id="operation_date"
          class="form-control" required></div>
        <div class="mb-3"><label>Type</label><select name="flow_type" id="flow_type" class="form-select">
          <option value="in">Entrée</option>
          <option value="out">Sortie</option>
        </select></div>
        <div class="mb-3"><label>Methode de paiement</label><select name="payment_method" id="payment_method"
          class="form-select">
        ...
        <div class="mb-3"><label>Montant</label><input type="number" step="0.01" name="amount" id="amount"
          class="form-control" required></div>
        <div class="mb-3"><label>Référence</label><input type="text" name="reference" id="reference"
          class="form-control"></div>
        <div class="mb-3"><label>Categorie de transaction</label><select name="category_id" id="category_id"
          class="form-select">
          <option value="">—</option>@foreach($categories as $ct)<option value="{{ $ct->id }}">{{ $ct->name }}
      </option>@endforeach
        </select></div>
        <div class="mb-3"><label>Contact (optionnel)</label><select name="contact_id" id="mov_contact_id"
          class="form-select">
          <option value="">—</option>@foreach($project->contacts as $ct)<option value="{{ $ct->id }}">
      {{ $ct->name }}</option>@endforeach
        </select></div>

        <div class="mb-3"><label>Description</label><textarea name="description" id="description"
